...
- `minor-meteor/AGENTS.md` – Source code and Astro project.
- `minor-meteor/.vercel/AGENTS.md` – Vercel build artifacts.
- `minor-meteor/src/AGENTS.md` – Source folder structure.
- `minor-meteor/src/pages/AGENTS.md` – Page components.
- `minor-meteor/src/pages/api/AGENTS.md` – API handlers.
